...
- [.Codex/skills/SKILLS.md](.Codex/skills/SKILLS.md) — Master architect reference for CAD fabrication and building design
- [.Codex/skills/sniff_screenshot.md](.Codex/skills/sniff_screenshot.md) — Headless screenshot environment guide
