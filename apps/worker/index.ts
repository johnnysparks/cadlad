    ...
    if (url.pathname === '/' || url.pathname === '/health') {
      return json({
        ...
        routes: [
          ...
          'GET  /api/live/session/:id/api-improvements',
          'GET  /api/live/session/:id/revisions',
          'GET  /api/live/session/:id/revisions/:revision',
          'GET  /api/live/session/:id/branches',
          'POST /api/live/session/:id/branches',
          'POST /api/live/session/:id/branches/:branchId/checkout',
          'GET  /api/live/session/:id/compare-branches?a=<branchId>&b=<branchId>',
